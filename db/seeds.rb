...
flights = [
  { code: "FL001", departure_airport_id: 1, arrival_airport_id: 2, departure_time: DateTime.now, flight_hour: 8 },
  ...
  { code: "FL004", departure_airport_id: 1, arrival_airport_id: 3, departure_time: DateTime.now + 3.day, flight_hour: 6 },
  { code: "FL005", departure_airport_id: 5, arrival_airport_id: 1, departure_time: DateTime.now, flight_hour: 5 },
  { code: "FL006", departure_airport_id: 6, arrival_airport_id: 2, departure_time: DateTime.now, flight_hour: 3 },
  ...
  { code: "FL010", departure_airport_id: 8, arrival_airport_id: 4, departure_time: DateTime.now + 2.days, flight_hour: 7 },
  ...
  { code: "FL014", departure_airport_id: 10, arrival_airport_id: 6, departure_time: DateTime.now + 2.days, flight_hour: 5 },
  { code: "FL015", departure_airport_id: 9, arrival_airport_id: 7, departure_time: DateTime.now + 3.days, flight_hour: 6 },
  { code: "FL016", departure_airport_id: 9, arrival_airport_id: 2, departure_time: DateTime.now + 3.days, flight_hour: 7 },
